...
const Page = () => {
  ...
  return (
    <>
      <div className="p-4 md:p-14 fullwh bg-conic relative">
        <Navbar />
        <AnimatePresence>
          <motion.div
          ...
          >
            ...
            <div
              className="flex justify-between items-center w-fit pl-3 border-[#ff66c4] border-[1px] mt-24 cursor-pointer"
              onClick={() => {}}
            >
              <div className="uppercase text-[12px] text-[#ff66c4] mr-5 tracking-wider md:text-[16px]">
                Get Started
              </div>
              <Image
          ...
          <motion.div
            className="text-[#ff66c4] w-fit h-fit mt-[215px] sm:mt-[140px] font-sans"
            key="username"
            initial={{
              opacity: 0,
            }}
